...
if(~exist('h', 'var') || ~ishandle(h))
    h = figure(1);
    ax = axes('box','on','CameraPosition',[1,1,.5]);
end
...
while (get(button, 'UserData'))
    ...
    %line([0 0],  [0 0],  [0 gz], 'Color', 'y', 'LineWidth', 2, 'Marker', 'o');
    
    % plot3(gx,'Color', 'r', 'LineWidth', 2, 'Marker', 'o',gy,...
    %    'Color', 'b', 'LineWidth', 2, 'Marker', 'o',gz,'Color', 'y', 'LineWidth',...
    %    2, 'Marker', 'o');
    % plot3(gx,gy,gz,'Color', 'r', 'LineWidth', 2, 'Marker', 'o');
